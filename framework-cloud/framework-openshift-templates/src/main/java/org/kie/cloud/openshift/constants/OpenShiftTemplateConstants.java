...
public class OpenShiftTemplateConstants {
    ...
    public static final String KIE_SERVER_EXTERNALDB_SERVICE_HOST = "KIE_SERVER_EXTERNALDB_SERVICE_HOST";
    public static final String KIE_SERVER_EXTERNALDB_SERVICE_PORT = "KIE_SERVER_EXTERNALDB_SERVICE_PORT";
    ...
    public static final String KIE_SERVER_ROUTER_HTTPS_SECRET = "KIE_SERVER_ROUTER_HTTPS_SECRET";
    ...
    // Replicas
    public static final String BUSINESS_CENTRAL_CONTAINER_REPLICAS = "BUSINESS_CENTRAL_CONTAINER_REPLICAS";
    public static final String BUSINESS_CENTRAL_MONITORING_CONTAINER_REPLICAS = "BUSINESS_CENTRAL_MONITORING_CONTAINER_REPLICAS";
    public static final String SMART_ROUTER_CONTAINER_REPLICAS = "SMART_ROUTER_CONTAINER_REPLICAS";
    public static final String KIE_SERVER_CONTAINER_REPLICAS = "KIE_SERVER_CONTAINER_REPLICAS";
