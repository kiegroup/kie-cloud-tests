...
public abstract class AbstractOpenshiftScenarioBuilderTemplates<T> extends AbstractOpenshiftScenarioBuilder<T> {

    private ExternalDeploymentFactory factory = new ExternalDeploymentFactoryTemplates();
