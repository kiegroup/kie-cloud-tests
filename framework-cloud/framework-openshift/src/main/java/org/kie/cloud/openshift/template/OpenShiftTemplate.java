...
public enum OpenShiftTemplate {
    ...
    CLUSTERED_CONSOLE_CLUSTERED_KIE_SERVER_DATABASE(OpenShiftConstants.CLUSTERED_CONSOLE_CLUSTERED_KIE_SERVER_DATABASE),
    ...
    KIE_SERVER_S2I_AMQ(OpenShiftConstants.KIE_APP_TEMPLATE_KIE_SERVER_S2I_AMQ),
    CONSOLE_SMARTROUTER(OpenShiftConstants.KIE_APP_TEMPLATE_CONSOLE_SMARTROUTER),
    KIE_SERVER_DATABASE_HTTPS_S2I(OpenShiftConstants.KIE_APP_TEMPLATE_KIE_SERVER_DATABASE_HTTPS_S2I),
