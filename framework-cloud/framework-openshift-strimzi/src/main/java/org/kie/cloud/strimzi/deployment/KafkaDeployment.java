...
public class KafkaDeployment extends OpenShiftDeployment {

    private static final String STATEFUL_SET_NAME_SUFFIX = "-kafka";
    private static final String SERVICE_NAME_SUFFIX = "-kafka-brokers";
    private static final String POD_LABEL_KEY = "strimzi.io/name";
    private static final String KAFKA_POD_LABEL_VALUE_SUFFIX = "-kafka";

    private String clusterName;

    public KafkaDeployment(String clusterName, Project project) {
        super(project);
    ...
    public void waitForScale() {
        SupplierWaiter statefulSetExistWaiter = new SupplierWaiter(
        ...
        statefulSetExistWaiter.waitFor();
    ...
    protected void waitUntilAllPodsAreReadyAndRunning(int expectedPods) {
        try {
            getOpenShift().waiters()
                    .areExactlyNPodsReady(expectedPods, POD_LABEL_KEY, clusterName + KAFKA_POD_LABEL_VALUE_SUFFIX)
            ...
            getOpenShift().waiters()
                    .areExactlyNPodsRunning(expectedPods, POD_LABEL_KEY, clusterName + KAFKA_POD_LABEL_VALUE_SUFFIX)
                    .timeout(OpenShiftResourceConstants.PODS_START_TO_READY_TIMEOUT)
                    .reason("Waiting for " + expectedPods + " pods of stateful set " +
