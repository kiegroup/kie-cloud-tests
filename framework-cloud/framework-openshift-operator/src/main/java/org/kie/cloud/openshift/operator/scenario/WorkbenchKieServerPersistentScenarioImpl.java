...
public class WorkbenchKieServerPersistentScenarioImpl extends OpenShiftOperatorScenario implements WorkbenchKieServerPersistentScenario {
    ...
    public WorkbenchKieServerPersistentScenarioImpl(KieApp kieApp) {
        this.kieApp = kieApp;
    }
