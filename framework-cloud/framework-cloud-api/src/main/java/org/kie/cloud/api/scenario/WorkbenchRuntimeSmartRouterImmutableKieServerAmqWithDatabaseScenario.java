...
/**
 * Representation of deployment scenario with immutable Kie server and database.
 */
public interface WorkbenchRuntimeSmartRouterImmutableKieServerAmqWithDatabaseScenario extends KieDeploymentScenario<WorkbenchRuntimeSmartRouterImmutableKieServerAmqWithDatabaseScenario> {

    /**
     * Return Workbench runtime deployment.
     *
    ...
    /**
     * Return AMQ deployment.
     *
     * @return AmqDeployment
     * @see AmqDeployment
     */
    AmqDeployment getAmqDeployment();
}
