...
public interface WorkbenchKieServerPersistentSSOScenarioBuilder extends DeploymentScenarioBuilder<WorkbenchKieServerPersistentSSOScenario> {
     ...
     */
    WorkbenchKieServerPersistentSSOScenarioBuilder withExternalMavenRepo(String repoUrl, String repoUserName, String repoPassword);
     ...
     */
    WorkbenchKieServerPersistentSSOScenarioBuilder withBusinessCentralMavenUser(String user, String password);

    /**
     * @param kieServerId kie-server id
     * @return Builder with kie-server id set
     */
    WorkbenchKieServerPersistentSSOScenarioBuilder withKieServerId(String kieServerId);
     ...
     * @return Builder
     */
    WorkbenchKieServerPersistentSSOScenarioBuilder withHttpWorkbenchHostname(String http);
     ...
     * @return Builder
     */
    WorkbenchKieServerPersistentSSOScenarioBuilder withHttpsWorkbenchHostname(String https);
     ...
     * @return Builder
     */
    WorkbenchKieServerPersistentSSOScenarioBuilder withHttpKieServerHostname(String http);
     ...
     * @return Builder
     */
    WorkbenchKieServerPersistentSSOScenarioBuilder withHttpsKieServerHostname(String https);
}
