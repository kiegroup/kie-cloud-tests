...
public interface KieDeploymentScenarioBuilder<T extends DeploymentScenarioBuilder<U>, U extends DeploymentScenario<U>> extends DeploymentScenarioBuilder<U> {
    ...
    /**
     * Return setup builder with additional deployment scenario listener.
     * @param deploymentScenarioListener Deployment scenario listener
     * @return Builder with additional deployment scenario listener.
     */
    T withDeploymentScenarioListener(DeploymentScenarioListener<U> deploymentScenarioListener);
}
