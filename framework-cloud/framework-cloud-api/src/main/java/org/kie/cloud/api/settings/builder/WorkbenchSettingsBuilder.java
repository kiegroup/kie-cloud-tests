 ...
 *
 * If any environment variable isn't configured by SettingsBuilder, then is used
 * default variable from application template.
 */
public interface WorkbenchSettingsBuilder extends SettingsBuilder<DeploymentSettings> {

    /**
     * Return configured builder with Kie Admin user. This user it used as admin
     * for workbench.
     *
     * @param user
     * @param password
