...
public class LdapExternalDeploymentApb extends AbstractLdapExternalDeployment<Map<String, String>> implements ExternalDeploymentApb<LdapDeployment> {

    public LdapExternalDeploymentApb(Map<String, String> config) {
        super(config);
    }
    ...
    public void configure(Map<String, String> extraVars) {
        ...
        addEnvVar(extraVars, OpenShiftApbConstants.AUTH_LDAP_URL, deployment.getHost());
    }
