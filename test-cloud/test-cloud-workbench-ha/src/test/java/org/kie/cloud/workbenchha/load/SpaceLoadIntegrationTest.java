...
public class SpaceLoadIntegrationTest extends AbstractCloudIntegrationTest {
    ...
    public void testCreateAndDeleteSpaces() throws InterruptedException,ExecutionException {
        ...
        List<Callable<Collection<String>>> createTasks = runners.stream().map(runner -> runner.createSpaces("RANDOM GENERATE NAME", 1, 5)).collect(Collectors.toList());
