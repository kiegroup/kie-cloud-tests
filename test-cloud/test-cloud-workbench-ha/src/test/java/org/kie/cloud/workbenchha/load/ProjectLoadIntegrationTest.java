...
public class ProjectLoadIntegrationTest extends AbstractCloudIntegrationTest {
    ...
    public static void initializeDeployment() {
        ...
        deploymentScenario.setLogFolderName(ProjectLoadIntegrationTest.class.getSimpleName());
