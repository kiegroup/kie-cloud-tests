...
public class KieServerS2iWithSsoOptaplannerIntegrationTest extends AbstractMethodIsolatedCloudIntegrationTest<GenericScenario> {
    ...
    private static final String KIE_SERVER_NAME = "kieserver-sso-optaplan";
